const Home = () => {
  return (
    <div style={{ minHeight: "calc(100vh - 64px)", display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem", textAlign: "center", background: "#0a0a14", width: "100%" }}>
      <div style={{ maxWidth: "600px", width: "100%" }}>
        ...
        <p style={{ color: "#9090c0", lineHeight: 1.7, marginBottom: "2rem" }}>
          Apasionada por crear interfaces bonitas y funcionales con React y TypeScript.
        </p>
